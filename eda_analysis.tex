...
\hypersetup{
  pdftitle={Exploratory Analysis of Measles Susceptibility Trends in Glasgow (1998--2012)},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
\title{Exploratory Analysis of Measles Susceptibility Trends in Glasgow
(1998--2012)}
\author{}
\date{}
...
{\centering \includegraphics{eda_analysis_files/figure-pdf/unnamed-chunk-4-1.pdf}
...
{\centering \includegraphics{eda_analysis_files/figure-pdf/unnamed-chunk-5-1.pdf}
