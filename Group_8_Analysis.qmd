...
@tbl-summary *shows the mean measles susceptibility by year. No sharp decline is observed post-2004, indicating that vaccine hesitancy may have persisted after the Wakefield article's retraction. Any recovery in vaccination rates appears gradual.*
...
@fig-box and @fig-mean together show measles susceptibility trends across years and between periods. @fig-box highlights yearly distributions, with the 2004 retraction marked, showing a peak in 2008 but no sharp drop post-2004. @fig-mean compares average susceptibility before and after 2004, revealing only a slight decrease. These patterns align with @tbl-summary, suggesting vaccine hesitancy persisted beyond the article’s retraction.
