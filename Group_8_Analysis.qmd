...
@fig-box_1 and @fig-bar_1 together show measles susceptibility trends across years and between periods. @fig-box_1 highlights yearly distributions, with the 2004 retraction marked, showing a peak in 2008 but no sharp drop post-2004. @fig-bar_1 compares average susceptibility before and after 2004, revealing only a slight decrease. These patterns align with Table 1, suggesting vaccine hesitancy persisted beyond the article’s retraction.
