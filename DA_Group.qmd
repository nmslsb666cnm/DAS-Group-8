...
@fig-residuals shows that residuals are approximately centered around zero without clear structure, indicating no systematic model misspecification in full model. A few large residuals at higher fitted values are observed but not concerning.
```{r}
#| echo: false
#| label: fig-residuals
#| fig-cap: Residuals vs Fitted Values for the Full Model
#| fig-pos: "H"
#| fig-height: 2
# Pearson residuals
...
plot(fitted_probs, residuals_pearson,
